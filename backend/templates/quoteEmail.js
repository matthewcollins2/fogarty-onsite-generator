export const quoteHtmlEmail = (clientData) => {
  return `
    <div style="background-color: #ffffff; padding: 40px 0; font-family: sans-serif; width: 100%;">
      <center>
        ...
        <div style="background-color: #f4f4f4; max-width: 500px; padding: 30px; border-radius: 0 0 12px 12px; border: 1px solid #ddd; text-align: left; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
          ...
          <h2 style="margin-top: 0; color: #333; text-align: center;">New Quote Request</h2>
          <hr style="border: 0; border-top: 1px solid #ccc; margin: 20px 0;" />
          
          <p style="margin: 10px 0;"><strong style="color: #555;">Customer Name:</strong> ${clientData.name}</p>
          ...
          <p style="margin: 10px 0;"><strong style="color: #555;">Serial Number:</strong> ${clientData.genSerialNumber}</p>
        ...
        <div style="text-align: center; margin-top: 20px;">
          <a href="http://localhost:5173/admin/incoming/quotes" 
